...
\begin{document}
    ...
    After the introduction and motivation for the project, we will now formulate our problem statement. The goal is to retrieve a list of games (documents) sorted in decreasing order of similarity, based on a board configuration (the query).
