...
\begin{document}
    ...
    As you might notice, the encoding for the board state seems similar to the reachability encoding. In fact, reachability stronger than board state encoding as reachability includes the board state as well. Therefore, if you enable both encodings for the query, you will get the same results as if you only enabled reachability. This is illustrated below in figures [placeholder]. Figure [] shows
